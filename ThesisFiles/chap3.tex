...
\begin{proof}
	...
	Subcase (3.1): Assume the block for $s_1$ is in row $k-3$, and $s_0$ is in row $k-4$ but $s_3$ is not in the $(k-3)$th row and $s_2$ is not in the $(k-4)$th row. Then the subheap we are considering is as follows
	\begin{center}
	\begin{tikzpicture}[scale=0.45]
