...
In this section we will classify the T-avoiding elements in Coxeter systems of type $B_n$. Our main result in this section is Theorem~\ref{thm:classificationofB}. \textcolor{green}{Notice that if $n=2$, $W(B_2) \cong I_2(4)$, which by Section~\ref{sec:tavoidI} we know has no non-trivial T-avoiding elements. We proceed for $n \geq 3$.} First we need some preparatory lemmas. 
