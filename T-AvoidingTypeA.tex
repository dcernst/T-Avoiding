...
Let $\w=s_1 s_2 s_3 s_5$ be a reduced expression for $w \in \FC(\A_5)$. We see that $\w$ corresponds to the following element in $S_6$,~$\w=(12)(23)(34)(56)$. The labeled string diagram for $w$ is shown in Figure~\ref{fig:firststring}.\\	
\begin{figure*}[!ht]
...
Let $\w=s_1 s_2 s_3 s_5$ be a a reduced expression for $w \in \FC(A_5)$. The string diagram is as follows from Example~\ref{ex:first string}.\\
